...
<section class="section">
										...
										<ul class="card-meta list-inline">
											...
											<li class="list-inline-item">
												<ul class="card-meta-tag list-inline">
													<li class="list-inline-item"><a href="tags.html">${blog.getCategory()}</a></li>
												</ul>
											</li>
										</ul>
  ...
  <div class="widget">
    ...
    <form  action="search" method="post" name="mc-embedded-subscribe-form" target="_blank"
      class="widget-search">
      <input class="mb-3" id="search-query" name="search" type="search" placeholder="Your Email Address">
      <i class="ti-email"></i>
